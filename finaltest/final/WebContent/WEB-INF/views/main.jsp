                        ...
                        <div class="top-menu d-flex align-items-center">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                                    <a class="dropdown-item" href="Wpages/profile.jsp"><i class="ik ik-user dropdown-icon"></i> Profile</a>
                                    <a class="dropdown-item" href="#"><i class="ik ik-settings dropdown-icon"></i> Settings</a>
                                    <a class="dropdown-item" href="#"><span class="float-right"><span class="badge badge-primary">6</span></span><i class="ik ik-mail dropdown-icon"></i> Inbox</a>
                                    <a class="dropdown-item" href="#"><i class="ik ik-navigation dropdown-icon"></i> Message</a>
                                    <a class="dropdown-item" href="pages/login.jsp"><i class="ik ik-power dropdown-icon"></i> Logout</a>
                                </div>
                            </div>
                    ...
                    <div class="sidebar-content">
                        <div class="nav-container">
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item">
                                    <a href="pages/navbar.jsp"><i class="ik ik-menu"></i><span>Navigation</span> <span class="badge badge-success">New</span></a>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="javascript:void(0)"><i class="ik ik-layers"></i><span>Widgets</span> <span class="badge badge-danger">150+</span></a>
                                    <div class="submenu-content">
                                        <a href="pages/widgets.jsp" class="menu-item">Basic</a>
                                        <a href="pages/widget-statistic.jsp" class="menu-item">Statistic</a>
                                        <a href="pages/widget-data.jsp" class="menu-item">Data</a>
                                        <a href="pages/widget-chart.jsp" class="menu-item">Chart Widget</a>
                                    </div>
                                </div>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        <a href="pages/ui/alerts.jsp" class="menu-item">Alerts</a>
                                        <a href="pages/ui/badges.jsp" class="menu-item">Badges</a>
                                        <a href="pages/ui/buttons.jsp" class="menu-item">Buttons</a>
                                        <a href="pages/ui/navigation.jsp" class="menu-item">Navigation</a>
                                    </div>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-gitlab"></i><span>Advance</span> <span class="badge badge-success">New</span></a>
                                    <div class="submenu-content">
                                        <a href="pages/ui/modals.jsp" class="menu-item">Modals</a>
                                        <a href="pages/ui/notifications.jsp" class="menu-item">Notifications</a>
                                        <a href="pages/ui/carousel.jsp" class="menu-item">Slider</a>
                                        <a href="pages/ui/range-slider.jsp" class="menu-item">Range Slider</a>
                                        <a href="pages/ui/rating.jsp" class="menu-item">Rating</a>
                                    </div>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-package"></i><span>Extra</span></a>
                                    <div class="submenu-content">
                                        <a href="pages/ui/session-timeout.jsp" class="menu-item">Session Timeout</a>
                                    </div>
                                </div>
                                <div class="nav-item">
                                    <a href="pages/ui/icons.jsp"><i class="ik ik-command"></i><span>Icons</span></a>
                                </div>
                                <div class="nav-lavel">Forms</div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-edit"></i><span>Forms</span></a>
                                    <div class="submenu-content">
                                        <a href="pages/form-components.jsp" class="menu-item">Components</a>
                                        <a href="pages/form-addon.jsp" class="menu-item">Add-On</a>
                                        <a href="pages/form-advance.jsp" class="menu-item">Advance</a>
                                    </div>
                                </div>
                                <div class="nav-item">
                                    <a href="pages/form-picker.jsp"><i class="ik ik-terminal"></i><span>Form Picker</span> <span class="badge badge-success">New</span></a>
                                </div>

                                <div class="nav-lavel">Tables</div>
                                <div class="nav-item">
                                    <a href="pages/table-bootstrap.jsp"><i class="ik ik-credit-card"></i><span>Bootstrap Table</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="TestController"><i class="ik ik-inbox"></i><span>Data Table</span></a>
                                </div>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        <a href="views/pages/charts-chartist.jsp" class="menu-item active">Chartist</a>
                                        <a href="pages/charts-flot.jsp" class="menu-item">Flot</a>
                                        <a href="pages/charts-knob.jsp" class="menu-item">Knob</a>
                                        <a href="pages/charts-amcharts.jsp" class="menu-item">Amcharts</a>
                                    </div>
                                </div>

                                <div class="nav-lavel">Apps</div>
                                <div class="nav-item">
                                    <a href="pages/calendar.jsp"><i class="ik ik-calendar"></i><span>Calendar</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="pages/taskboard.jsp"><i class="ik ik-server"></i><span>Taskboard</span></a>
                                </div>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        <a href="pages/login.jsp" class="menu-item">Login</a>
                                        <a href="pages/register.jsp" class="menu-item">Register</a>
                                        <a href="pages/forgot-password.jsp" class="menu-item">Forgot Password</a>
                                    </div>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-file-text"></i><span>Other</span></a>
                                    <div class="submenu-content">
                                        <a href="pages/profile.jsp" class="menu-item">Profile</a>
                                        <a href="pages/invoice.jsp" class="menu-item">Invoice</a>
                                    </div>
                                </div>
                                <div class="nav-item">
                                    <a href="pages/layouts.jsp"><i class="ik ik-layout"></i><span>Layouts</span><span class="badge badge-success">New</span></a>
                                </div>
