...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Cards | ThemeKit - Admin Template</title>
            ...
            <div class="page-wrap">
                <div class="app-sidebar colored">
                    <div class="sidebar-header">
                        ...
                        <button type="button" class="btn-icon nav-toggle"><i data-toggle="expanded" class="ik ik-more-vertical toggle-icon"></i></button>
                        <button id="sidebarClose" class="nav-close btn-icon"><i class="ik ik-x"></i></button>
                    </div>
                        ...
                        <div class="nav-container">
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item has-sub active open">
                                    <a href="#"><i class="ik ik-command"></i><span>UI</span></a>
                                    <div class="submenu-content">
                                        ...
                                        <a href="../../pages/ui/cards.html" class="menu-item">Cards</a>
                                        <a href="../../pages/ui/icons.html" class="menu-item">Icons</a>
                                        <a href="../../pages/ui/modals.html" class="menu-item">Modal</a>
                                ...
                                <div class="nav-item">
                                    <a href="../../pages/widgets.html"><i class="ik ik-server"></i><span>Widgets</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="../../pages/taskboard.html"><i class="ik ik-list"></i><span>Taskboard</span></a>
                                </div>
                                ...
                                <div class="nav-item">
                                    <a href="../../pages/forms.html"><i class="ik ik-edit"></i><span>Forms</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="../../pages/charts.html"><i class="ik ik-pie-chart"></i><span>Charts</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="../../pages/tables.html"><i class="ik ik-clipboard"></i><span>Tables</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="../../pages/carousel.html"><i class="ik ik-layers"></i><span>Carousel</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="../../pages/layouts.html"><i class="ik ik-layout"></i><span>Layouts</span></a>
                                </div>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-lg-3 col-12">
                                        <div class="card bg-dark text-white">
                                            <img class="card-img" src="../../img/portfolio-4.jpg" alt="Card image">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card d-flex flex-row">
                                            <a class="d-flex" href="#">
                                                <img alt="Thumbnail" src="../../img/portfolio-5.jpg" class="list-thumbnail responsive border-0">
                                            </a>
                                ...
                                <div class="row">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="text-center">
                                                    <img alt="Profile" src="../../img/user.jpg" class="img-thumbnail border-0 rounded-circle mb-4 list-thumbnail">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-lg-4 col-12 mb-4">
                                        <div class="card d-flex flex-row">
                                            <a class="d-flex" href="#">
                                                <img alt="Profile" src="../../img/user.jpg" class="img-thumbnail border-0 rounded-circle m-4 list-thumbnail align-self-center small">
                                            </a>
