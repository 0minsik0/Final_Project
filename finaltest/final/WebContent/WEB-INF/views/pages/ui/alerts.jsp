...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Alerts | ThemeKit - Admin Template</title>
                        ...
                        <div class="nav-container">
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item has-sub active open">
                                    ...
                                    <div class="submenu-content">
                                        <a href="alerts.html" class="menu-item active">Alerts</a>
                ...
                <div class="main-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header"><h3>Bootstrap Alert</h3></div>
                                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header"><h3>Bootstrap alerts in fill colors</h3></div>
                                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header"><h3>Dismissing Alert</h3></div>
                                    <div class="card-body">
