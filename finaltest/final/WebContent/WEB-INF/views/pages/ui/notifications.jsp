...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Notifications | ThemeKit - Admin Template</title>
        ...
        <link rel="stylesheet" href="../resources/node_modules/jquery-toast-plugin/dist/jquery.toast.min.css">
                ...
                <div class="main-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header"><h3>Jquery Toast Styles</h3></div>
                                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header"><h3>Jquery Toast Positions</h3></div>
                                    <div class="card-body">
