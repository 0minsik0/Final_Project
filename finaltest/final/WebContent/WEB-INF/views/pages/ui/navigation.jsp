...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Navigation | ThemeKit - Admin Template</title>
                            ...
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item has-sub active open">
                                    ...
                                    <div class="submenu-content">
                                        ...
                                        <a href="navigation.html" class="menu-item active">Navigation</a>
                                    </div>
                                </div>
                                <div class="nav-item has-sub">
                ...
                <div class="main-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header"><h3>Nav Basic</h3></div>
                                    <div class="card-body">
                                        <ul class="nav">
                                            <li class="nav-item">
                                ...
                                <div class="card">
                                    <div class="card-header"><h3>Nav Horizontal Alignment</h3></div>
                                    <div class="card-body">
                                ...
                                <div class="card">
                                    <div class="card-header"><h3>Nav Vertical Alignment</h3></div>
                                    <div class="card-body">
                                ...
                                <div class="card">
                                    <div class="card-header"><h3>Nav Pills</h3></div>
                                    <div class="card-body">
                                ...
                                <div class="card">
                                    <div class="card-header"><h3>Nav Pill and Justify</h3></div>
                                    <div class="card-body">
                                ...
                                <div class="card">
                                    <div class="card-header"><h3>Nav Pills with Dropdowns</h3></div>
                                    <div class="card-body">
                                        <ul class="nav nav-pills">
                                            <li class="nav-item">
                                                <a class="nav-link active" href="#">Active</a>
                                            ...
                                            <li class="nav-item dropdown">
                                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Dropdown <i class="ik ik-chevron-down"></i></a>
                                ...
                                <div class="card">
                                    <div class="card-header"><h3>Pagination Basic</h3></div>
                                    <div class="card-body">
