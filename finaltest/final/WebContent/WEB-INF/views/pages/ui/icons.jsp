...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Icons | ThemeKit - Admin Template</title>
            ...
            <div class="page-wrap">
                ...
                <div class="main-content">
                    <div class="container-fluid">
                        ...
                        <div class="card"> 
                            <div class="card-header justify-content-between"><h3>Font Kit Icons</h3> <a class="btn btn-theme pull-right" target="_blank" href="http://iconkit.lavalite.org/">IconKit</a></div>
                            <div class="card-body">
                                <style>
                        ...
                        <div class="modal fade full-window-modal" id="fullwindowModal" tabindex="-1" role="dialog" aria-labelledby="fullwindowModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="fullwindowModalLabel">Modal title</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    </div>
                                    <div class="modal-body">
                                    ...
