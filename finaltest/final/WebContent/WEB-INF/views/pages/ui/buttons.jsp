...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Buttons | ThemeKit - Admin Template</title>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card-header"><h3>Normal buttons</h3></div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="card-header"><h3>Fab Buttons</h3></div>
                                            <div class="card-body template-demo">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card-header"><h3>Outlined buttons</h3></div>
                                            <div class="card-body template-demo">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card-header"><h3>Rounded Outlines</h3></div>
                                            <div class="card-body template-demo">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card-header"><h3>Rounded filled Buttons</h3></div>
                                            <div class="card-body template-demo">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card-header"><h3>Button Block</h3></div>
                                            <div class="card-body template-demo">
                                                <button type="button" class="btn btn-info btn-block">Block Button</button>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="card-header"><h3>Icons Buttons</h3></div>
                                            <div class="card-body template-demo">
                                                <button type="button" class="btn btn-light"><i class="ik ik-heart"></i>Default</button>
                                                <button type="button" class="btn btn-primary"><i class="ik ik-star"></i>Primary</button>
                                                <button type="button" class="btn btn-success"><i class="ik ik-check-circle"></i>Success</button>
                                                <button type="button" class="btn btn-secondary"><i class="ik ik-clipboard"></i>Submit</button>
                                                <button type="button" class="btn btn-dark"><i class="ik ik-edit-2"></i>Edit</button>
                                                <button type="button" class="btn btn-danger"><i class="ik ik-info"></i>Warning</button>
                                                <button type="button" class="btn btn-info"><i class="ik ik-share"></i>Upload</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card-header"><h3>Grouped buttons</h3></div>
                                            <div class="card-body template-demo">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card-header"><h3>Social Buttons</h3></div>
                                            <div class="card-body template-demo">
