...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Invoice | ThemeKit - Admin Template</title>
            ...
            <div class="page-wrap">
                            ...
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item has-sub open active">
                                    ...
                                    <div class="submenu-content">
                                        ...
                                        <a href="invoice.html" class="menu-item active">Invoice</a>
                                    </div>
                                </div>
                                <div class="nav-item">
                ...
                <div class="main-content">
                    <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-header"><h3 class="d-block w-100">ThemeKit<small class="float-right">Date: 12/11/2018</small></h3></div>
                            <div class="card-body">
